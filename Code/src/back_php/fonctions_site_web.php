...
// Si une erreur se produit, ou si l'utilisateur n'est pas censé avoir accès à cette page,
// cette page est affichée à la place
// Le code de cette fonction ainsi que le layout s'inspire grandement des pages "erreur 404" du site Deltarune.com
